...
if __name__ == '__main__':
    ...
    if START_FRAME <= 0 or START_FRAME > total_frames:
        print(f'Start frame should be in range [1, {total_frames}], because prepare_video have {total_frames} frames')
        exit(-1)

    if END_FRAME < START_FRAME or END_FRAME > total_frames:
        print(f'End frame should be in range [{START_FRAME}, {total_frames}], because prepare_video have {total_frames} '
